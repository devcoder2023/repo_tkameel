...
<body>
            ...
            <div class="widget widgetDashboard">
                ...
                <div class="widgetBody widgetDashboardBody grid">
                    ...
                    <div class="card cardBoard cardBoardMembers">
                        ...
                        <div id="containerChartMemberJoinPie" class="containerChart hide">
                            <div class="header">
                                    <h2>
                                        أنواع الأعضاء القبولين
                                    </h2>
                                </div>
                            <div class="body">
                                <canvas id="canvasBoardMembersJoin" width="200px" height="160px"></canvas>
                            </div>
                            <div class="footer">
                                <h6>
    ...
    <div style="display: none;">
        ...
        <svg display="none">
            <symbol viewBox="-3 -3 30 30" id="svgterminate">
                <title>icon-terminate</title>
                <g transform="matrix(1.0695549,0,0,1.0695549,-0.7486648,-0.9806535)">
                <path d="M 12,21 C 10.22,21 8.47991,20.4722 6.99987,19.4832 5.51983,18.4943 4.36628,17.0887 3.68509,15.4442 3.0039,13.7996 2.82567,11.99 3.17294,10.2442 3.5202,8.49836 4.37737,6.89472 5.63604,5.63604 6.89472,4.37737 8.49836,3.5202 10.2442,3.17294 c 1.7458,-0.34727 3.5554,-0.16904 5.2,0.51215 1.6445,0.68119 3.0501,1.83474 4.039,3.31478 C 20.4722,8.47991 21,10.22 21,12 21,14.387 20.0518,16.6761 18.364,18.364 16.6761,20.0518 14.387,21 12,21 Z M 12,4.5 C 10.5166,4.5 9.0666,4.93987 7.83323,5.76398 6.59986,6.58809 5.63856,7.75943 5.07091,9.12988 4.50325,10.5003 4.35473,12.0083 4.64411,13.4632 c 0.28939,1.4548 1.0037,2.7912 2.05259,3.8401 1.0489,1.0489 2.38527,1.7632 3.8401,2.0526 1.4549,0.2894 2.9629,0.1409 4.3333,-0.4268 1.3705,-0.5677 2.5418,-1.529 3.3659,-2.7623 C 19.0601,14.9334 19.5,13.4834 19.5,12 19.5,10.0109 18.7098,8.10323 17.3033,6.6967 15.8968,5.29018 13.9891,4.5 12,4.5 Z"></path>
                <path d="m 14.5,8 h -5 C 8.67157,8 8,8.67157 8,9.5 v 5 C 8,15.3284 8.67157,16 9.5,16 h 5 c 0.8284,0 1.5,-0.6716 1.5,-1.5 v -5 C 16,8.67157 15.3284,8 14.5,8 Z"></path>
                </g>
            </symbol>
        </svg>
